\section{Hiện thực}
Hệ thống khóa điện tử nhập số được thiết kế dựa trên mô hình máy trạng thái hữu hạn (Finite State Machine - FSM) với mười bốn trạng thái hoạt động riêng biệt. Máy trạng thái được triển khai thông qua ba module chính:
\begin{itemize}
...
\url{https://drive.google.com/file/d/1TCnZJqhzMKbLzAA-fE1OvaO3ULszKEpr/view}
