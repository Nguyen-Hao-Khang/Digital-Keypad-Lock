...
dùng sử dụng phương thức mở khóa bằng chìa cơ, vi điều khiển sẽ đọc trạng thái từ button gắn với ổ khóa cơ học để thực hiện hành động tương ứng để mở khóa.
...
\begin{itemize}
    ...
    \item Một button cơ học được lắp đặt tại vị trí ổ khóa cơ có chức năng phát hiện và thông báo cho MCU khi 
...
\begin{itemize}
    ...
    \item Về phần cảm biến, hệ thống sử dụng một button cảm biến trạng thái cửa nhận biết vị trí đóng hoặc mở 
        của cánh cửa và gửi về MCU, phục vụ cho thao tác cảnh báo người dùng.
\end{itemize}
\subsection{Khối quản lý năng lượng:}
Trong thiết kế hệ thống, khối quản lý năng lượng được xây dựng dựa trên phương án lý thuyết như sau:
\begin{itemize}
